...
(SAP QM prod-001 tag series). The model must operate in advisory mode (no DCS
...
**Ground truth source:** SAP QM prod-001 tag series (frozen at project start, 81,906 records)
...
- domain-evaluator:
  Apply prod-001 vibration priors — bearing failure signatures via envelope
