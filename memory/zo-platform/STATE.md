...
ZO v1.0.2-pre — **pre-prod-001 hardening complete**. Phase persistence fixed, delivery scaffold with Docker added, auto-notebook generation built, preflight validation added. 334 tests, ruff clean, validate-docs 9/9. Ready for prod-001.
...
1. **prod-001** — first real production project (oil & gas refinery optimization)
