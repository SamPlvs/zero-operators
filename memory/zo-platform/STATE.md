...
ZO v1.0.2-pre — **pre-prod-001 hardening complete**. Phase persistence fixed, delivery scaffold with Docker added, auto-notebook generation built, preflight validation added, orchestrator pipeline wired. 338 tests, ruff clean, validate-docs 9/9. Ready for CIFAR-10 demo.
...
1. **CIFAR-10 demo** — smoke test full pipeline on new machine, then prod-001
...
5. XAI + Domain Evaluator activation for prod-001 Phase 5
