...
prs: #22-#25 (UX), #26 (training dashboard + test reports), #27 (draft scout team), #28 (dynamic agents), pending (init-architect + prod-001 readiness), pending (branded `zo --help`)
