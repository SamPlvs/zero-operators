...
1. **Find analogous problems** — search for the problem CLASS, not the exact dataset. "Soft sensor for chemical purity" has literature even if prod-001's specific reactor doesn't.
